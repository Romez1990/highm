    ...
    },
    {
      ...
      text: [
        <Fragment>
          ...
          Для этого необходимо перейти на страницу групп, в правом верхнем углу
          таблицы нажать кнопку &quot;Добавить&quot;, вписать название группы,
          ввести список студентов, которые обучаются в данной группе и нажать
          кнопку &quot;Добавить&quot;. В списке появится созданная группа, при
          нажатии на которую осуществится переход на страницу группы, где можно
          увидеть список всех студентов, добавить нового, изменить данные
          существующих, а также удалить студентов. При добавлении новый участник
          помечается как незарегистрированный, если нажать кнопку
          &quot;Регистрационные коды&quot; в правом верхнем углу таблицы, то
          можно посмотреть список всех незарегистрированных студентов и их
          регистрационные коды. Также имеется кнопка для печати таблицы
          регистрационных кодов или сохранения таблицы как PDF файла. Эти
          регистрационные коды необходимо передать студентам для того, чтобы они
          смогли зарегистрироваться. После того, как студент зарегистрирован, он
          исчезает из списка регистрационных кодов и помечается как
          зарегистрированный. Группы разграничиваются между преподавателями. Они
          не могут видеть группы, созданные другим преподавателем, а также
          изменять состав студентов группы.
        </Fragment>,
        <Fragment>
          ...
          студента, количество набранных им балла за всю работу и по каждому
          заданию.
        </Fragment>,
      ],
      actions: [
    ...
    },
    {
      ...
      text: (
        <Fragment>
          ...
          создания необходимо перейти на страницу преподавателей и в правом
          верхнем углу таблицы нажать кнопку &quot;Добавить&quot;, вписать имя
          преподавателя и нажать кнопку &quot;Добавить&quot;. В списке появится
          созданный преподаватель. В списке преподавателей также можно изменить
          данные существующих преподавателей и удалить их. При добавлении нового
          преподавателя он помечается как незарегистрированный и если нажать
          кнопку &quot;Регистрационные коды&quot; в правом верхнем углу таблицы,
          то можно посмотреть список всех незарегистрированных преподавателей и
          их регистрационные коды. Также имеется кнопка для печати таблицы
          ...
          помечается как зарегистрированный.
        </Fragment>
      ),
      actions: [
        {
