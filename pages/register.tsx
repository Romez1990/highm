...
import RegistrationStoreProvider from '../components/Auth/RegistrationStoreProvider';
...
RegisterationPageWrapper.getInitialProps = async ({
  res,
  query,
...
function RegisterationPageWrapper({
...
export default RegisterationPageWrapper;
